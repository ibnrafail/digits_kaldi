...
utils/mkgraph.sh data/lang exp/sgmm2_5a exp/sgmm2_5a/graph
steps/decode_sgmm2.sh --nj 1 --cmd "$decode_cmd" --transform-dir exp/tri4b/decode_1 exp/sgmm2_5a/graph data/test_1 exp/sgmm2_5a/decode_1
steps/decode_sgmm2.sh --nj 1 --cmd "$decode_cmd" --transform-dir exp/tri4b/decode_2 exp/sgmm2_5a/graph data/test_2 exp/sgmm2_5a/decode_2
...
for iter in 1 2 3 4; do
	steps/decode_sgmm2_rescore.sh --cmd "$decode_cmd" --iter $iter --transform-dir exp/tri4b/decode_1 data/lang data/test_1 exp/sgmm2_5a/decode_1 exp/sgmm2_5a_mmi_b0.1/decode_1_it$iter &
	steps/decode_sgmm2_rescore.sh --cmd "$decode_cmd" --iter $iter --transform-dir exp/tri4b/decode_2 data/lang data/test_2 exp/sgmm2_5a/decode_2 exp/sgmm2_5a_mmi_b0.1/decode_2_it$iter &
done
...
for iter in 1 2 3 4; do
	steps/decode_sgmm2_rescore.sh --cmd "$decode_cmd" --iter $iter --transform-dir exp/tri4b/decode_1 data/lang data/test_1 exp/sgmm2_5a/decode_1 exp/sgmm2_5a_mmi_b0.1_m0.9/decode_1_it$iter &
	steps/decode_sgmm2_rescore.sh --cmd "$decode_cmd" --iter $iter --transform-dir exp/tri4b/decode_2 data/lang data/test_2 exp/sgmm2_5a/decode_2 exp/sgmm2_5a_mmi_b0.1_m0.9/decode_2_it$iter &
done
...
#steps/train_ubm.sh --cmd run.pl 400 data/train data/lang exp/tri4b_ali exp/ubm5a
